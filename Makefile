# =============================================================================
# Lazarus — Makefile (Phase 1 infra dev/ops shortcuts)
# =============================================================================
# Wraps `docker compose` for kafka, redis, prometheus, and grafana.
#
# Run from repo root:
#   make help
#   make infra-up
#
# Prerequisites: Docker Compose, .env (cp .env.example .env)
# Windows: install GNU Make (scoop install make) — see docs/arch_01.md Subtask 6
# =============================================================================

# Scoop Make on Windows: run recipes in Git Bash so grep/awk/test work.
ifeq ($(OS),Windows_NT)
